...
|      |                                                                                                        |
|------|--------------------------------------------------------------------------------------------------------|
| Code | CONTAINS('Phys/[StdLooseMergedPi0](../commonparticles/stripping21-stdloosemergedpi0.md)/Particles')\>0 |
...
|-----------------|---------------------------------------------------------------------------------------|
| Code            | (PT \> 200.0)                                                                         |
| Inputs          | \[ 'Phys/[StdLooseMergedPi0](../commonparticles/stripping21-stdloosemergedpi0.md)' \] |
| DecayDescriptor | None                                                                                  |
